...
/// Function
///
/// delete: Function deletes a file from a specific location
///
/// #Arguments
///
...
pub async fn delete(path: String) -> serde_json::Result<String> {
...
/// Function
///
/// rename: Function renames a file in a specific location
///
/// #Arguments
///
...
///
/// Returns serde_json::Result<String>
pub async fn rename(from: String, to: String) -> serde_json::Result<String> {
...
/// Function
///
/// create_file:Function creates a file at a specific location
///
/// #Arguments
///
...
///
/// Returns serde_json::Result<String>
pub async fn create(path: String) -> serde_json::Result<String> {
